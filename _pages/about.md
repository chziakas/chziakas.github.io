...
Before pursuing a PhD in AI, I co-founded [**Athina AI (YC W23)**](https://www.athina.ai/), an LLM observability startup. I also hold an MSc in Data Science from [**TU Munich**](https://www.tum.de/), where my thesis on deep generative models was supervised by [**Prof. Stephan Günnemann**](https://scholar.google.com/citations?user=npqoAWwAAAAJ&hl=de) and hosted at [**BMW**](https://www.bmwgroup.com/).
